 ...
 * Owner: PerryPlaysMC
 * From: 11/3/19-2200
 * Package: dev.perryplaysmc.voidpvp.utils
 * Class: XMaterial
 * <p>
 * Path: dev.perryplaysmc.voidpvp.utils.XMaterial
 * <p>
...
public enum XMaterial {
    ...
    */
    ...
    public static Optional<XMaterial> matchXMaterial(int id, byte data) {
        ...
        for (XMaterial materials : VALUES)
            if ((data==-1&&materials.getId() == id)||((materials.data == data) && materials.getId() == id)) return Optional.of(materials);
        return Optional.empty();
    }

    public static XMaterial fromString(String name) {
        return XMaterial.contains(name) ? XMaterial.matchXMaterial(name).get() : null;
    }

    public static XMaterial fromMaterial(Material name) {
        return XMaterial.contains(name.name()) ? XMaterial.matchXMaterial(name.name()).get() : null;
    }

    public static XMaterial byId(int id) {
        Optional<XMaterial> mat = XMaterial.matchXMaterial(id, (byte)-1);
        return mat.isPresent() ? mat.get() : XMaterial.values()[id];
    }
